...
//  pogoda
//
//  Created by Гость on 27.05.2022.
//
...
class ViewController: UIViewController {
    ...
    func updateWeatherInfo(latitude: Double, longtitude: Double) {
        ...
        let url = URL(string: "http://api.openweathermap.org/data/2.5/weather?lat=\(latitude.description)&lon=\(longtitude.description)&units=metric&lang=ru&APPID=f1ef90ffbeec89541034ca21533d26d8")!
